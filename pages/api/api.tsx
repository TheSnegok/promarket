...
export const listLogoBrands: IBrand[] = [
	{
		name: "Hansgrohe",
		description: "Немецкий производитель сантехники. Компания была основана Гансом Гроэ в 1901 году в Шильтахе, Баден-Вюртемберг, Германия. Hansgrohe является одним из крупнейших в мире поставщиков насадок для душа, ручных душей и смесителей, наряду с такими конкурентами, как Grohe и Kohler.",
		img: hansgrohe,
		url: "/"
	},
	{
...
export const providers = [
	{
		...
		text: 'Откройте ссылку внизу для заполнения анкеты и следуя интсрукции заполните её.',
		link: {
			href: '/',
	...
	},
	{
		...
		text: 'Уточните что вы будете продавать, в каком количестве и за сколько и занесите это в список ваших товаров по кнопке снизу.',
		link: {
			href: '/',
			text: 'Список товаров'
		}
	},
	{
		...
		text: 'Откройте договор по кнопке снизу, ознакомтесь с ним и подпишите.',
		link: {
			href: '/',
			text: 'Договор'
		}
	},
	{
		...
		text: 'Поздравляем, если вы сделали все шаги сверху правильно, то у вас появится ваш личный кабинет в который вы можете перейти по кнопке снизу.',
		link: {
			href: '/',
			text: 'Личный кабинет'
		}
